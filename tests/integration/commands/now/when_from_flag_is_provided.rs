...
fn it_sets_start_and_done_from_range() {
  ...
  doing
    .run([
      "now",
      "--from",
      "2026-03-22 13:00 to 2026-03-22 15:00",
      "From range entry",
    ])
    .assert()
    .success();
  ...
  assert_times_within_tolerance(&start_time, "2026-03-22 13:00", 1, "start should be 1pm");
  assert_times_within_tolerance(&done_time, "2026-03-22 15:00", 1, "done should be 3pm");
}
